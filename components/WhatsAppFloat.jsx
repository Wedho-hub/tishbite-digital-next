...
export default function WhatsAppFloat() {
  // On phones the Hero image sits above the H1, pushing it into the same
  // lower-viewport area this fixed bubble occupies. Keep it hidden on small
  // screens until the user has scrolled roughly past the hero fold.
